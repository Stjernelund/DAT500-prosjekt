...
if __name__ == "__main__":
    ...
    for i in range(10):
        start = time.time()
        vectorizer = CountVectorizer(inputCol='words', outputCol='vectorizer',vocabSize=1000,minDF=0.1).fit(wordsData)
    ...
    for i in range(10):
        ...
        tfidfVectorizer = TfidfVectorizer(norm=None,analyzer='word',
            tokenizer=dummy_fun,preprocessor=dummy_fun,token_pattern=None,stop_words=my_stop_words,max_features=1000,min_df=0.1)
